...
SET DEFINE OFF;
Insert into CFG_EXP_FL01 (FLUSSO,POSITION,FIELD,TYPE,FORMAT) values ('REP_01',3,'DES_NOME','VARCHAR',null);
Insert into CFG_EXP_FL01 (FLUSSO,POSITION,FIELD,TYPE,FORMAT) values ('REP_01',4,'COD_ATTIVITA','NUMBER','FM999.009');
Insert into CFG_EXP_FL01 (FLUSSO,POSITION,FIELD,TYPE,FORMAT) values ('REP_01',1,'DES_COGNOME','VARCHAR',null);
Insert into CFG_EXP_FL01 (FLUSSO,POSITION,FIELD,TYPE,FORMAT) values ('REP_01',2,'COD_STATO','VARCHAR',null);
Insert into CFG_EXP_FL01 (FLUSSO,POSITION,FIELD,TYPE,FORMAT) values ('REP_01',5,'DTA_CREAZIONE','DATE','DD-MM-YYYY');

SET DEFINE OFF;
Insert into CFG_EXP_FL02 (FLUSSO,TABELLA,CONDITION,SEPARATOR) values ('REP_01','TABLE','WHERE 1=1',';');

SET DEFINE OFF;
Insert into CFG_EXP_FLHE (FLUSSO,POSITION,FIELD) values ('REP_01',0,'HEADER');
